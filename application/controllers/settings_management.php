...
class Settings_Management extends MY_Controller {
	...
	public function updateTables(){
		...
		// check the data if available (sync_regimen_category)
		...
		//check if data is available (cdrr_item)
		...
		// check data if available (regimen category)
			...
			// Table Regimen Category Updates
