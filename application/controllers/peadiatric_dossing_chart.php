...
class peadiatric_dossing_chart extends MY_Controller {
	function __construct() {
		parent::__construct();
		$this -> session -> set_userdata("link_id", "index");
		$this -> session -> set_userdata("linkSub", "peadiatric_dossing_chart");
		$this -> session -> set_userdata("linkTitle", "peadiatric Dossing Chart");
	}
	...
	public function listing() {
		...
		$this -> table -> set_heading('fff','Minimum Weight', 'Maximum Weight','Drug', 'Dose','Options');
